# Perfil do recurso Composition que cria as secções da noticia nascimento - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/CompositionNoticia | *Version*:1.0.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.noticia-nascimento|current/StructureDefinition/StructureDefinition-CompositionNoticia.json)
...
```json
{
  ...
  "url" : "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/CompositionNoticia",
  "version" : "1.0.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Pregnancy"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Birth"]
      }]
    },
    {
      ...
      "type" : [{
        ...
        "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Contact"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Child"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/ApgarScore"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Malformation"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Phototherapy"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Hearingscreen"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Congenital"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Metabolic"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Pupillary"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Newbornriskassessment"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Hepb"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Bcg"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Antid"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Puerperium"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Childhealthsurveilance"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Bulletindelivery"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Letter"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Transport"]
      }]
    },
    {
