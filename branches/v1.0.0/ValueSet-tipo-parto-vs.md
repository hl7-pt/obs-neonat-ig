# Tipos de parto ValueSet - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/noticia-nascimento/ValueSet/tipo-parto-vs | *Version*:1.0.0 |
...
```json
{
  ...
  "id" : "tipo-parto-vs",
  "url" : "https://hl7.pt/fhir/noticia-nascimento/ValueSet/tipo-parto-vs",
  "version" : "1.0.0",
  "name" : "TipoPartoVS",
