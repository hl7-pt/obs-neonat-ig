# Perfil para o profissional de saúde - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Professional | *Version*:1.0.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.noticia-nascimento|current/StructureDefinition/StructureDefinition-Professional.json)
...
```json
{
  ...
  "id" : "Professional",
  "url" : "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Professional",
  "version" : "1.0.0",
  "name" : "Professional",
