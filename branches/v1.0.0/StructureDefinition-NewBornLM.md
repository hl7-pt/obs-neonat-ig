# Recem-nascido (modelo) - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/NewBornLM | *Version*:1.0.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.noticia-nascimento|current/StructureDefinition/StructureDefinition-NewBornLM.json)
...
```json
{
  ...
  "url" : "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/NewBornLM",
  "version" : "1.0.0",
  "name" : "NewBornLM",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/NewBornLM",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "1",
      "type" : [{
        "code" : "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/VaccineLM"
      }]
    },
    {
      "id" : "NewBornLM.BCG",
