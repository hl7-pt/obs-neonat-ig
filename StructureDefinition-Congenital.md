# Perfil de informação clinicas - Rastreio Cardiopatias Congénitas - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Congenital | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-Congenital.json)
...
```json
{
  ...
  "id" : "Congenital",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Congenital",
  "version" : "0.0.1",
  "name" : "Congenital",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://hl7.pt/fhir/NoticiaNascimento/ValueSet/newborn-congenital-anomalies-vs"
      }
    },
    {
      "id" : "Observation.note",
