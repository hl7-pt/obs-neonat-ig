# Perfil de informação clinicas - apgarScore - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/ApgarScore | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-ApgarScore.json)
...
```json
{
  ...
  "id" : "ApgarScore",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/ApgarScore",
  "version" : "0.0.1",
  "name" : "ApgarScore",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/ApgarScore"
      }]
    },
    {
