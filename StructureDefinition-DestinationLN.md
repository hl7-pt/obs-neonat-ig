# Dados da inscrição nos cuidados de saúde primários (modelo) - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/DestinationLN | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-DestinationLN.json)
...
```json
{
  ...
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/DestinationLN",
  "version" : "0.0.1",
  "name" : "DestinationLN",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/DestinationLN",
