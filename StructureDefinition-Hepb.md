# Perfil de Informação sobre vacinação - hepb - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Hepb | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-Hepb.json)
...
```json
{
  ...
  "id" : "Hepb",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Hepb",
  "version" : "0.0.1",
  "name" : "Hepb",
