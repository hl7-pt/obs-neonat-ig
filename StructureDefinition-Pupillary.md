# Perfil de informação clinicas - Teste Reflexo pupilar - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Pupillary | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-Pupillary.json)
...
```json
{
  ...
  "id" : "Pupillary",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Pupillary",
  "version" : "0.0.1",
  "name" : "Pupillary",
