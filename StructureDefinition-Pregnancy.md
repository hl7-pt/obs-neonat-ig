# Perfil de Informação de gravidez - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Pregnancy | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-Pregnancy.json)
...
```json
{
  ...
  "id" : "Pregnancy",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Pregnancy",
  "version" : "0.0.1",
  "name" : "Pregnancy",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://hl7.pt/fhir/NoticiaNascimento/ValueSet/risco-gravidez-vs"
      }
    },
    {
    ...
    },
    {
      ...
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "https://hl7.pt/fhir/NoticiaNascimento/CodeSystem/InfosGravidezCS",
          "code" : "PREGRISKREASON",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://hl7.pt/fhir/NoticiaNascimento/ValueSet/tipo-gravidez-vs"
      }
    }]
  }
}
