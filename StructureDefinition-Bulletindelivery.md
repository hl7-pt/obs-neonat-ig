# Perfil de Informação sobre entrega de boletim - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Bulletindelivery | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-Bulletindelivery.json)
...
```json
{
  ...
  "id" : "Bulletindelivery",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Bulletindelivery",
  "version" : "0.0.1",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://hl7.pt/fhir/NoticiaNascimento/ValueSet/document-type-vs"
      }
    },
    {
      "id" : "Procedure.code",
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://hl7.pt/fhir/NoticiaNascimento/ValueSet/bulletin-delivery-vs"
      }
    },
    {
