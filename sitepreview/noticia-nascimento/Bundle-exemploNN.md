# exemploNN - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v1.0.0
...
```json
{
  ...
  "entry" : [{
    ...
    "resource" : {
      ...
      "id" : "compNN",
      "meta" : {
        "profile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/CompositionNoticia"]
      },
      "text" : {
        "status" : "generated",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "id" : "mother",
      "meta" : {
        "profile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Mother"]
      },
      "text" : {
        "status" : "generated",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "id" : "episodio",
      "meta" : {
        "profile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Contact"]
      },
      "text" : {
        "status" : "generated",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "id" : "newBornNN",
      "meta" : {
        "profile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Child"]
      },
      "text" : {
        "status" : "generated",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "id" : "vaccNN-hepb",
      "meta" : {
        "profile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Hepb"]
      },
      "text" : {
        "status" : "generated",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "id" : "vaccNN-bcg",
      "meta" : {
        "profile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Bcg"]
      },
      "text" : {
        "status" : "generated",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "id" : "apgar-example",
      "meta" : {
        "profile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/ApgarScore"]
      },
      "text" : {
        "status" : "generated",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Pupillary"]
      },
      "text" : {
        "status" : "generated",
