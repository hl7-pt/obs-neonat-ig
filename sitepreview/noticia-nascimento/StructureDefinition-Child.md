# Perfil do recém-nascido - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Child | *Version*:1.0.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.noticia-nascimento|current/StructureDefinition/StructureDefinition-Child.json)
...
```json
{
  ...
  "id" : "Child",
  "url" : "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Child",
  "version" : "1.0.0",
  "name" : "Child",
