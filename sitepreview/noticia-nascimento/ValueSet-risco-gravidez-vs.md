# Risco de gravidez ValueSet - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/noticia-nascimento/ValueSet/risco-gravidez-vs | *Version*:1.0.0 |
...
```json
{
  ...
  "url" : "https://hl7.pt/fhir/noticia-nascimento/ValueSet/risco-gravidez-vs",
  "version" : "1.0.0",
