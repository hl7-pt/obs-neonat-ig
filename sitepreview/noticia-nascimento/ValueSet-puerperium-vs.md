# Tipos de outcome de puerpério ValueSet - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/noticia-nascimento/ValueSet/puerperium-vs | *Version*:1.0.0 |
...
```json
{
  ...
  "id" : "puerperium-vs",
  "url" : "https://hl7.pt/fhir/noticia-nascimento/ValueSet/puerperium-vs",
  "version" : "1.0.0",
  "name" : "PuerperiumVS",
