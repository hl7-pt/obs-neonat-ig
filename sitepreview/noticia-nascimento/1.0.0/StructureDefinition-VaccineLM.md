# Vacina (modelo) - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/VaccineLM | *Version*:1.0.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.noticia-nascimento|current/StructureDefinition/StructureDefinition-VaccineLM.json)
...
```json
{
  ...
  "url" : "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/VaccineLM",
  "version" : "1.0.0",
  "name" : "VaccineLM",
  "title" : "Vacina (modelo)",
  "status" : "active",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/VaccineLM",
