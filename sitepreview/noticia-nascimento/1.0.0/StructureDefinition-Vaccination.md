# Perfil sobre Informação sobre vacinação - genérico - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Vaccination | *Version*:1.0.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.noticia-nascimento|current/StructureDefinition/StructureDefinition-Vaccination.json)
...
```json
{
  ...
  "id" : "Vaccination",
  "url" : "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Vaccination",
  "version" : "1.0.0",
  "name" : "Vaccination",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "https://hl7.pt/fhir/noticia-nascimento/StructureDefinition/Vaccination"
      }]
    },
    {
