# Perfil de Informação do Parto - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Birth | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-Birth.json)
...
```json
{
  ...
  "id" : "Birth",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Birth",
  "version" : "0.0.1",
  "name" : "Birth",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://hl7.pt/fhir/NoticiaNascimento/ValueSet/tipo-parto-vs"
      }
    },
    {
