# Perfil sobre episódio da notícia de nascimento - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Contact | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-Contact.json)
...
```json
{
  ...
  "id" : "Contact",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Contact",
  "version" : "0.0.1",
  "name" : "Contact",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://hl7.pt/fhir/NoticiaNascimento/ValueSet/episode-type-vs"
      }
    },
    {
