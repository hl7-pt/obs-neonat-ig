# Perfil de informação clinicas - Fototerapia - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Phototherapy | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-Phototherapy.json)
...
```json
{
  ...
  "id" : "Phototherapy",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Phototherapy",
  "version" : "0.0.1",
  "name" : "Phototherapy",
