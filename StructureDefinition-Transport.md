# Perfil de informação sobre Transportes - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Transport | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-Transport.json)
...
```json
{
  ...
  "id" : "Transport",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Transport",
  "version" : "0.0.1",
  "name" : "Transport",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/transport-information"]
      }]
    },
    {
      "id" : "Basic.code",
