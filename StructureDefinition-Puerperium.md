# Perfil para registar dados do puerpério até à alta - HL7 PT FHIR Implementation Guide: Noticia de Nascimento v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Puerperium | *Version*:0.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.pt.obs-neonat|current/StructureDefinition/StructureDefinition-Puerperium.json)
...
```json
{
  ...
  "id" : "Puerperium",
  "url" : "https://hl7.pt/fhir/NoticiaNascimento/StructureDefinition/Puerperium",
  "version" : "0.0.1",
  "name" : "Puerperium",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://hl7.pt/fhir/NoticiaNascimento/ValueSet/puerperium-vs"
      }
    },
    {
      "id" : "Observation.note",
